...
recipient_key3 = RSA.import_key(open("key/public3.pem").read())

session_key = get_random_bytes(16)
custom_modulus = recipient_key1.n * recipient_key2.n * recipient_key3.n

#simple rsa encryption
enc_session_key = rsa_encrypt(session_key, 65537, custom_modulus).to_bytes(768, "big")
